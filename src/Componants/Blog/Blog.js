    ...
    return (
        <div className=" container blog-items">
            <div className="articles">
                <h1 className="article-header">Google Data Analytics Professional Certificate</h1>
                <p className="article">About this Professional Certificate
                    5,067,949 recent views
                    ...
                    In addition to expert training and hands-on projects, you'll complete a case study that you can share with potential employers to showcase your new skill set. Learn concrete skills that top employers are hiring for right now.</p>
            </div>
            <div className="articles">
                <h1 className="article-header">IBM Data Science Professional Certificate</h1>
                <p className="article">About this Professional Certificate
                    684,101 recent views
                    ...
                    Projects: random album generator, predict housing prices, best classifier model, Predicting successful rocket landing, dashboa rd and interactive map</p>
            </div>
            <div className="articles">
                <h1 className="article-header">IBM Data Analyst Professional Certificate</h1>
                <p className="article">About this Professional Certificate
                    421,993 recent views
                    ...
                    All these projects can be combined into a portfolio on GitHub or another service to clearly convey your experience and skills to potential employers.</p>
            </div>
            <div className="articles">
                <h1 className="article-header">IBM Machine Learning Professional Certificate</h1>
                <p className="article">About this Professional Certificate
                    50,305 recent views
                    ...
                    Libraries: Pandas, NumPy, Matplotlib, Seaborn, ipython-sql, Scikit-learn, ScipPy, Keras, and TensorFlow.</p>
            </div>
            <div className="articles">
                <h1 className="article-header">SAS Advanced Programmer Professional Certificate</h1>
                <p className="article" >About this Professional Certificate
                    6,888 recent views
